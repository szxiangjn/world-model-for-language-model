...
class EnvironmentState(object):
    ...
    def get_state_node(self, obj: ScriptObject):
        return self.select_nodes(obj)[0]
    ...
    def change_state(self, changers: List['StateChanger'], node: Node = None, obj: ScriptObject = None):
        ...
        new_state._new_nodes = deepcopy(self._new_nodes)
        new_state._removed_edges_from = deepcopy(self._removed_edges_from)
        new_state._new_edges_from = deepcopy(self._new_edges_from)
        new_state._script_objects = deepcopy(self._script_objects)
        new_state.executor_data = deepcopy(self.executor_data)
